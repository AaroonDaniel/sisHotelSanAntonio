...
export default function FinancialReport({ auth, users = [], Filters }: Props) {
    ...
    const handleCerrarCaja = () => {
        if (confirm('¿Estás seguro de que todo está en orden? Al confirmar, se cerrará tu caja y el sistema cerrará tu sesión.')) {
                ...
                <div className="flex-1 flex justify-center items-start overflow-hidden pb-4">
                    ...
                    {pdfUrl && formato === 'pdf' ? (
                        <div className="w-full h-full flex flex-col overflow-hidden rounded-2xl bg-white shadow-2xl border border-gray-200 animate-in zoom-in-95 duration-200">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between border-b border-gray-100 bg-gray-50 px-6 py-4 gap-4">
                                ...
                                <div className="flex flex-wrap items-center justify-center gap-3">
                                    <button 
                                        ...
                                        className="flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 transition shadow-sm"
                                    >
                                    ...
                                    {auth.active_register && (
                                        ...
                                        >
                                            <LogOut className="h-4 w-4" /> Todo en orden: Cerrar Caja y Salir
                                        </button>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="bg-yellow-50 border-b border-yellow-200 px-6 py-2 text-sm text-yellow-800 flex items-center justify-center gap-2">
                                <Printer className="h-4 w-4" />
                                <p>No olvides <b>imprimir el PDF</b> usando el botón de la impresora dentro del visor antes de salir del sistema.</p>
                            </div>
                                ...
                                <div className="flex-shrink-0 flex justify-end gap-3 border-t border-gray-100 bg-gray-50/50 px-6 py-4">
                                    ...
                                    >
                                        {isGenerating ? (
                                            ...
                                            <><FileText className="h-4 w-4" /> Generar y Revisar</>
                                        )}
                                    </button>
                                </div>
                            </form>
