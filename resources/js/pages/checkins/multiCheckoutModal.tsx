...
export default function MultiCheckoutModal({
    ...
    useEffect(() => {
        ...
        // Limpiar el operador que finaliza
    ...
    const handleConfirmAndPreview = async () => {
        // 🛑 CANDADO ABSOLUTO: sin operador seleccionado, no se finaliza
        // ninguna estadía bajo ninguna circunstancia (mismo patrón que
        // checkinModal).
    ...
    return (
        <div className="fixed inset-0 z-50 flex animate-in items-center justify-center bg-black/60 p-4 backdrop-blur-sm duration-200 zoom-in-95 fade-in">
            <div className="relative w-full max-w-5xl">
                ...
                <div className="flex h-[80vh] w-full flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
                    {/* HEADER MODAL */}
