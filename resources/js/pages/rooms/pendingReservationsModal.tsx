...
export default function PendingReservationsModal({
    ...
    // Lógica de cancelar directamente usando router
    const handleCancel = (id: number) => {
        if (
            confirm(
                '¿Estás seguro de cancelar esta reserva? Las habitaciones quedarán LIBRES.',
            )
        ) {
            router.put(
                `/reservas/${id}`,
                                                ...
                                                <div className="overflow-hidden">
                                                    <div className="mt-1 flex w-full overflow-hidden rounded-xl border border-gray-200 shadow-sm">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex flex-1 items-center justify-center gap-2 bg-green-600 py-2 text-[11px] font-bold text-white uppercase transition hover:bg-green-500 active:scale-95 disabled:opacity-50"
                                                        >
                                                            {processing
                                                                ? 'Procesando...'
                                                                : 'Confirmar Reserva'}
