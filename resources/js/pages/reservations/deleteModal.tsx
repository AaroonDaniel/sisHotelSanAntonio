...
export default function DeleteModal({ show, onClose, reservationId }: DeleteModalProps) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        if (reservationId) {
            ...
            destroy(`/reservas/${reservationId}`, {
                onSuccess: () => onClose(),
            });
        }
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm transition-opacity animate-in fade-in duration-200">
            <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl animate-in zoom-in-95 duration-200">
                <div className="p-6 text-center">
                    ...
                    {/* CORRECCIÓN: Cambiar texto a 'Tarifa' */}
                    <h3 className="mb-2 text-xl font-bold text-gray-800">¿Eliminar tarifa?</h3>
                    <p className="text-gray-500">
                        Esta acción no se puede deshacer. La tarifa será eliminada permanentemente del sistema.
                    </p>
