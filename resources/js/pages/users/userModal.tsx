...
export default function UserModal({
    ...
    useEffect(() => {
        if (show) {
            if (userToEdit) {
                ...
                const isPredefined = shiftOptions.some(
                    (opt) => opt.value === existingShift,
                );
    ...
    return (
        <div className="fixed inset-0 z-50 flex animate-in items-center justify-center bg-black/60 p-4 backdrop-blur-sm transition-opacity duration-200 fade-in">
            ...
            <div className="flex max-h-[80vh] w-full max-w-lg animate-in flex-col overflow-hidden rounded-2xl bg-white shadow-2xl duration-200 zoom-in-95">
                    ...
                    <div className="custom-scrollbar flex-1 space-y-4 overflow-y-auto p-6">
                        ...
                        <div className="grid grid-cols-1 items-start gap-4 sm:grid-cols-2">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {isCustomShift && (
                                    <div className="flex animate-in items-center gap-2 rounded-lg border border-dashed border-blue-300 bg-blue-50 p-2 slide-in-from-top-2">
                                        <input
                                            type="time"
                                            value={customStart}
                                            onChange={(e) =>
                        ...
                        <label className="mb-1.5 block text-sm font-semibold text-gray-700">
                            ...
                            {isEditing ? (
                                ...
                                <span className="text-xs font-normal text-gray-400">
                                    (temporal, se genera del usuario)
                                </span>
                            )}
                        </label>
                        <div className="relative">
                            ...
                            {isEditing ? (
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-500 py-2 pr-3 pl-10 text-base text-black focus:border-gray-600 focus:ring-0"
                                    placeholder="********"
                                />
                            ) : (
                                <input
                                    ...
                                    disabled
                                    readOnly
                                    className="w-full cursor-not-allowed rounded-lg border border-gray-800 bg-gray-100 py-2 pr-3 pl-10 text-base text-gray-500"
                                    placeholder="Escriba el usuario para generar la contraseña"
                                />
                            )}
                        </div>
                    </div>
