 ...
 *
 * Por decisión de negocio, este panel no tiene vistas ni PDFs propios: la
 * previsualización de un turno puntual reutiliza el modal y el endpoint
 * `/reports/financial/pdf` que ya usa el recepcionista en rooms/status.tsx
 * (ver ShiftPreviewModal.tsx).
 */
